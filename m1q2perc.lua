...
--
Stages = {
	{ name = "M1", tasks = 100, distr = {type = "exp", params = {rate = 1/1000.0}}, pre = {}, post = {"R2"} },
	{ name = "M4", tasks = 100, distr = {type = "exp", params = {rate = 1/1500.0}}, pre = {}, post = {"R5"} },
	{ name = "R5", tasks = 80, distr = {type = "exp", params = {rate = 1/500.0}},  pre = {"M4"}, post = {"R2"} },
	{ name = "R2", tasks = 100, distr = {type = "exp", params = {rate = 1/500.0}},  pre = {"M1","R5"}, post = {"R3"} },
	{ name = "R3", tasks = 100, distr = {type = "exp", params = {rate = 1/500.0}},  pre = {"R2"}, post = {} }
};
